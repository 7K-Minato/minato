...
```bash
cosign verify --certificate-oidc-issuer https://token.actions.githubusercontent.com harbor.7kgroup.com/7kminato/minato-operator:v1.0.0
```
      ...
      validate:
        ...
        pattern:
          spec:
            containers:
              - name: "*"
                image: "harbor.7kgroup.com/7kminato/minato-*"
```
