...
func TestRouteGuard(t *testing.T) {
	...
	cases := []struct {
		...
		{"viewer reads sftp info forbidden", http.MethodGet, "/api/v1/gameservers/default/gs1/sftp", "viewer", http.StatusForbidden},
		{"operator reads sftp info", http.MethodGet, "/api/v1/gameservers/default/gs1/sftp", "operator", http.StatusOK},
		{"admin reads sftp info", http.MethodGet, "/api/v1/gameservers/default/gs1/sftp", "admin", http.StatusOK},
